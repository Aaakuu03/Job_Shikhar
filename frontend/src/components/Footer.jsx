      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <Briefcase className="h-6 w-6 text-price-purple" />
              <h3 className="text-xl font-bold">Job Shikhar</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-400">
                <span className="mr-2">📍</span> Kathmandu, Nepal
              </li>
              <li className="flex items-center text-gray-400">
                <span className="mr-2">📞</span> +977 1 4123456
              </li>
              <li className="flex items-center text-gray-400">
                <span className="mr-2">📧</span> info@jobshikhar.com
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 Job Shikhar. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
